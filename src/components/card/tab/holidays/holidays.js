    ...
    methods: {
      ...
      colorRow(row,){
        ...
        if ( future ){
          ...
          return 'appui-hr-card-tab-holidays-past' + (count % 2 === 0 ? ' bbn-alt-light' : '');
        }
      }
    },
    component: {
    ...
    <div>
      <div class="bbn-middle appui-hr-card-tab-holidays-legend bbn-h-100">
        ...
        data(){
          return {
            hr: this.closest('appui-hr-main'),
            card: this.closest('appui-hr-card'),
            currentStatus: null,
            currentMonth: null,
            ...
            period: [{
              text: bbn._('Past'),
              value: 'past',
              icon: 'nf nf-fa-square appui-hr-card-tab-holidays-past',
              color: 'lightpink'
            }, {
              text: bbn._('Ongoing'),
              value: 'ongoing',
              ...
              text: bbn._('Future'),
              value: 'future',
              icon: 'nf nf-fa-square appui-hr-card-tab-holidays-future',
              color: 'lightcyan'
            }],
            currentPeriod: null
          }
          ...
          currentPeriod(newVal, oldVal){
            if ( newVal !== oldVal ){
              ...
              if ( newVal ){
                ...
                this.table.currentFilters.conditions.splice(0, this.table.currentFilters.conditions.length, mainFilter, cond);
              }
              else {
                this.table.currentFilters.conditions.splice(0, this.table.currentFilters.conditions.length, mainFilter);
              }
